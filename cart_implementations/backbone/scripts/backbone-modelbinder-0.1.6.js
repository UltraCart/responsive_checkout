  ...
  _.extend(Backbone.ModelBinder.prototype, {
    ...
    _copyViewToModel: function (elementBinding, el) {
      ...
      if (!el._isSetting) {
        ...
        // Perry Tew:  I commented out the following lines.  They made no sense, and we breaking because the _setModel
        // up above was trigger changes, which were triggering render(), which was calling modelBinder.bind(), which was
        // stomping on this._model, which made the following line throw an error.
...
//        }
    ...
    _setModel: function (elementBinding, el) {
      ...
      // Perry Tew - adding a trim to all input to avoid spaces.
      elVal = jQuery.trim(elVal);
